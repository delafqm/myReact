  ...
  <Row gutter={24}>
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        contentHeight={46}
      >
        <MiniProgress percent={70} strokeWidth={8} target={80} color="#13C2C2" />
      </ChartCard>
    </Col>
  </Row>
));
